                ...
                <nav class="navbar navbar-expand">
                    <div class="collapse navbar-collapse justify-content-between">
                        ...
                        <ul class="navbar-nav header-right">
                            ...
                            <li class="nav-item">
                                <a class="btn btn-primary d-sm-inline-block d-none" href="{{ route('logout') }}"
                ...
                <ul class="metismenu" id="menu">
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="{{ route('transaksiduapuluhsatu/index') }}">PPH 21</a></li>
                            <li><a href="{{ route('transaksiduapuluhdua/index') }}">PPH 22</a></li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="index.html">BUAT INVOICE</a></li>
                            <li><a href="index-2.html">BUAT E-FAKTUR</a></li>
                        </ul>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            ...
                            <li><a href="./post-details.html">E-FAKTUR</a></li>
                            <li><a href="./post-details.html">E-BUPOT</a></li>
                    ...
                    <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">
                        ...
                        <ul aria-expanded="false">
                            <li><a href="./chart-flot.html">ID BILLING</a></li>
