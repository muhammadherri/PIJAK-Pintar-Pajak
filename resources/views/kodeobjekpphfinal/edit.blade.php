                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                <form action="{{ route('kodeobjekpphfinal/update',[$kopfinal->id]) }}" method="POST" enctype="multipart/form-data">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input autocomplete="off" value="{{$kopfinal->kode_objek}}" required id="kode" name="kode"type="text" class="form-control"
