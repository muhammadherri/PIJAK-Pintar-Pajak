        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form action="{{ route('categorypengeluaran/store') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            @method('POST')
                                ...
                                <div class="form-group row">
                                    <div class="col-md-2">
                                        <div class="mb-2">
                                            ...
                                            <input type="text" id="sewa_kos" name="sewa_kos" class="form-control"
                                                required autocomplete="off">

                                        </div>
                                        <div class="mb-2">
                                            <label class="form-label" for="segment1">Makan</label>
                                            <input type="text" id="makan" name="makan" class="form-control"
                                                required autocomplete="off">

                                        </div>
                                        <div class="mb-2">
                                            <label class="form-label" for="segment1">Pakaian</label>
                                            <input type="text" id="pakaian" name="pakaian" class="form-control"
                                                required autocomplete="off">

                                        </div>
                                        <div class="mb-2">
                                            <label class="form-label" for="segment1">Nonton</label>
                                            <input type="text" id="nonton" name="nonton" class="form-control"
                                                required autocomplete="off">
