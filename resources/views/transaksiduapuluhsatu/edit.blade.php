                                ...
                                <form action="{{ route('transaksipph21/store') }}" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input autocomplete="off" id="input_wajib_pajak" name="input_wajib_pajak" value="{{$pph21->nama_wajib_pajak}}" type="text"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input autocomplete="off" value="{{$pph21->no_npwp}}" id="no_npwp" name="no_npwp" type="number" class="form-control"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input autocomplete="off" value="{{$pph21->gaji_pensiun}}" type="number" id="gajidanpensiun" name="gajidanpensiun"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input autocomplete="off" value="{{$pph21->tunjangan_pph}}" id="tunjangan_pph" name="tunjangan_pph" type="number"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input autocomplete="off" value="{{$pph21->tunjangan_lain}}"  type="number" id="tunjanganlain" name="tunjanganlain"
                                                    class="form-control"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input autocomplete="off" value="{{$pph21->honorarium}}"  type="number" id="honorarium" name="honorarium"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input autocomplete="off" value="{{$pph21->premi_asuransi}}"  type="number" id="premi_asuransi" name="premi_asuransi"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input autocomplete="off" value="{{$pph21->natura}}" type="number" id="natura" name="natura" class="form-control"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input autocomplete="off" value="{{$pph21->tantiem}}" type="number" id="tantiem" name="tantiem" class="form-control"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input autocomplete="off" value="{{$pph21->penghasilan_bruto}}" type="number" id="penghasilan_bruto" name="penghasilan_bruto"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input autocomplete="off" value="{{$pph21->biaya_jabatan}}" type="number" id="biaya_jabatan" name="biaya_jabatan"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input autocomplete="off" value="{{$pph21->tht_jht}}" type="number" id="iuran_pensiun" name="iuran_pensiun"
                                                    class="form-control"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-3">
                                                <input autocomplete="off" value="{{$pph21->tht_jht}}" type="number" id="potongantarif1" name="potongantarif1"
                                                    class="form-control" placeholder="Masukkan Potongan">
                                            </div>
                                            <div class="col-sm-3">
                                        ...
                                        <div class="mb-3 row">
                                            <label class="col-sm-3 col-form-label">PPH 21</label>
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        [inputpotongantarif1, inputtarif1, inputpotongantarif2, inputtarif2, inputpotongantarif3, inputtarif3,
