                                ...
                                <form action="{{ route('transaksipph21/store') }}" method="POST"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input required min="0" onkeyup="this.value=sprator(this.value);" autocomplete="off" type="text" id="gajidanpensiun"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input required min="0" onkeyup="this.value=sprator(this.value);" autocomplete="off" id="tunjangan_pph" name="tunjangan_pph"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input autocomplete="off" onkeyup="this.value=sprator(this.value);" type="text" id="tunjanganlain"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input required min="0" onkeyup="this.value=sprator(this.value);" autocomplete="off" type="text" id="honorarium"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input required min="0" onkeyup="this.value=sprator(this.value);" autocomplete="off" type="text" id="premi_asuransi"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input required min="0" onkeyup="this.value=sprator(this.value);" autocomplete="off" type="text" id="natura" name="natura"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input required min="0" onkeyup="this.value=sprator(this.value);" autocomplete="off" type="text" id="tantiem" name="tantiem"
                                                    class="form-control"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input required min="0" readonly autocomplete="off" type="text" id="penghasilan_bruto"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input required min="0" autocomplete="off" onkeyup="this.value=sprator(this.value);" type="text" id="biaya_jabatan" name="biaya_jabatan"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input required min="0" onkeyup="this.value=sprator(this.value);" autocomplete="off" type="text" id="iuran_pensiun"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input placeholder="Masukkan Total Pengurang" readonly type="text" id="total_pengurang"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input placeholder="Masukkan Penghasilan Netto" autocomplete="off" onkeyup="this.value=sprator(this.value);" type="text" id="penghasilan_netto"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input placeholder="Masukkan Netto Pertahun" autocomplete="off" 
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input placeholder="Masukkan Nilai PKP" onkeyup="this.value=sprator(this.value);"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-3">
                                                <input required min="0" onkeyup="this.value=sprator(this.value);"
                                                 autocomplete="off" type="text" id="potongantarif1"
                                                    name="potongantarif1" class="form-control"
                                                    placeholder="Masukkan Tarif">
                                            </div>
                                            <div class="col-sm-3">
                                                <input required min="0" autocomplete="off" onkeyup="this.value=sprator(this.value);" type="text" id="tarif1" name="tarif1"
                                                    class="form-control" placeholder="Masukkan PKP">
                                            </div>
                                            <div class="col-sm-3">
                                                <input autocomplete="off" readonly type="text" id="totaltarif1"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-3">
                                                <input required min="0" onkeyup="this.value=sprator(this.value);" autocomplete="off" type="text" id="potongantarif2"
                                                    name="potongantarif2" class="form-control"
                                                    placeholder="Masukkan Tarif">
                                            </div>
                                            <div class="col-sm-3">
                                                <input required min="0" autocomplete="off" onkeyup="this.value=sprator(this.value);"
                                                 type="text" id="tarif2" name="tarif2"
                                                    class="form-control" placeholder="Masukkan PKP">
                                            </div>
                                            <div class="col-sm-3">
                                                <input autocomplete="off" readonly type="text" id="totaltarif2"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-3">
                                                <input autocomplete="off" readonly type="text" id="totaltarif3"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-3">
                                                <input autocomplete="off" readonly type="text" id="totaltarif4"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input placeholder="Masukkan Nilai PPH 21 PKP" autocomplete="off" readonly type="text" id="jumlahtotal"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input required min="0" placeholder="Masukkan Nilai PPH 21 Potongan" onkeyup="this.value=sprator(this.value);"
...
<script>
    ...
    //         const rupiah = parseFloat(gajidanpensiun.value) || 0;
    ...
    //             tantiem;
    //         var separatorbruto=bruto.toLocaleString();

    //         // console.log(document.getElementById('inputpenghasilan_bruto').textContent=separatorbruto);
                
    //         inputpenghasilan_bruto.value = bruto.toLocaleString();
