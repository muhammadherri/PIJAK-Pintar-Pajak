                                ...
                                <form action="{{ route('dokumenreferensi/update',[$doc->id]) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input value="{{$doc->no}}" autocomplete="off" required id="no" name="no" type="number" class="form-control"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input value="{{$doc->jenis_dokumen}}" autocomplete="off" required id="jenisdokumen" name="jenisdokumen" type="text" class="form-control"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input value="{{$doc->sertifikat}}" autocomplete="off" required id="sertifikat" name="sertifikat" type="text" class="form-control"
