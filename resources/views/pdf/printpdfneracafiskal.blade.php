    ...
    <body>
        <table cellpadding="2" border="1" id="laporanfiskal" class="display" >
            <thead>
                ...
                <tr>
                    <th width="auto" class="text-center">Akun</th>
                    <th width="auto" class="text-center">DESKRIPSI NAMA AKUN</th>
                    ...
                    <th width="auto" class="text-center">Nama</th>
                </tr>
            ...
            @foreach ($asetlancar1110 as $key => $row)
                <tr>
                    ...
                    <td width="auto" class="text-center">{{ Str::limit($row->attribute3, 16)}}</td>
                </tr>
            @endforeach
