                                        ...
                                        <div class="tab-pane fade show active" id="nav-1721" role="tabpanel"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input autocomplete="off"   id="id_npwp_1721"
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input autocomplete="off"   id="id_nama_1721"
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <textarea autocomplete="off"   id="id_alamat_1721" name="id_alamat_1721" type="text" class="form-control"
                                                ...
                                                {{-- <div class="mb-3 row">
                                                    <label class="col-sm-3 col-form-label">Alamat</label>
                                                    <div class="col-sm-9">
                                                        <textarea autocomplete="off"   id="op_alamat_1721" name="op_alamat_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Alamat"></textarea>
                                                    </div>
                                                </div> --}}
                                                ...
                                                <div class="mb-3 row">
                                                    <div class="col-sm-4">
                                                        ...
                                                        <input autocomplete="off"   id="b1_penerima_penghasilan_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b1_penerima_penghasilan_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Penerima Penghasilan" min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Penghasilan Bruto</label>
                                                        <input autocomplete="off"   id="b1_penghasilan_bruto_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b1_penghasilan_bruto_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Jumlah Penghasilan Bruto" min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Pajak Dipotong</label>
                                                        <input autocomplete="off"   id="b1_jumlahpajak_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b1_jumlahpajak_1721" type="text" class="form-control"
                                                ...
                                                <div class="mb-3 row">
                                                    <div class="col-sm-4">
                                                        <label>Penerima Penghasilan</label>
                                                        <input autocomplete="off"   id="b2_penerima_penghasilan_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b2_penerima_penghasilan_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Penerima Penghasilan" min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Penghasilan Bruto</label>
                                                        <input autocomplete="off"   id="b2_penghasilan_bruto_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b2_penghasilan_bruto_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Jumlah Penghasilan Bruto" min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Pajak Dipotong</label>
                                                        <input autocomplete="off"   id="b2_jumlahpajak_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b2_jumlahpajak_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Jumlah Pajak Dipotong" min="0">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 row">
                                                    <div class="col-sm-4">
                                                        <label>Penerima Penghasilan</label>
                                                        <input autocomplete="off"   id="b3_penerima_penghasilan_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b3_penerima_penghasilan_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Penerima Penghasilan" min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Penghasilan Bruto</label>
                                                        <input autocomplete="off"   id="b3_penghasilan_bruto_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b3_penghasilan_bruto_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Jumlah Penghasilan Bruto" min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Pajak Dipotong</label>
                                                        <input autocomplete="off"   id="b3_jumlahpajak_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b3_jumlahpajak_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Jumlah Pajak Dipotong" min="0">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 row">
                                                    <div class="col-sm-4">
                                                        <label>Penerima Penghasilan</label>
                                                        <input autocomplete="off"   id="b4a_penerima_penghasilan_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b4a_penerima_penghasilan_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Penerima Penghasilan" min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Penghasilan Bruto</label>
                                                        <input autocomplete="off"   id="b4a_penghasilan_bruto_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b4a_penghasilan_bruto_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Jumlah Penghasilan Bruto" min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Pajak Dipotong</label>
                                                        <input autocomplete="off"   id="b4a_jumlahpajak_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b4a_jumlahpajak_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Jumlah Pajak Dipotong" min="0">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 row">
                                                    <div class="col-sm-4">
                                                        <label>Penerima Penghasilan</label>
                                                        <input autocomplete="off"   id="b4b_penerima_penghasilan_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b4b_penerima_penghasilan_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Penerima Penghasilan" min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Penghasilan Bruto</label>
                                                        <input autocomplete="off"   id="b4b_penghasilan_bruto_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b4b_penghasilan_bruto_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Jumlah Penghasilan Bruto" min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Pajak Dipotong</label>
                                                        <input autocomplete="off"   id="b4b_jumlahpajak_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b4b_jumlahpajak_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Jumlah Pajak Dipotong" min="0">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 row">
                                                    <div class="col-sm-4">
                                                        <label>Penerima Penghasilan</label>
                                                        <input autocomplete="off"   id="b4c_penerima_penghasilan_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b4c_penerima_penghasilan_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Penerima Penghasilan" min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Penghasilan Bruto</label>
                                                        <input autocomplete="off"   id="b4c_penghasilan_bruto_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b4c_penghasilan_bruto_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Jumlah Penghasilan Bruto" min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Pajak Dipotong</label>
                                                        <input autocomplete="off"   id="b4c_jumlahpajak_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b4c_jumlahpajak_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Jumlah Pajak Dipotong" min="0">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 row">
                                                    <div class="col-sm-4">
                                                        <label>Penerima Penghasilan</label>
                                                        <input autocomplete="off"   id="b4d_penerima_penghasilan_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b4d_penerima_penghasilan_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Penerima Penghasilan" min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Penghasilan Bruto</label>
                                                        <input autocomplete="off"   id="b4d_penghasilan_bruto_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b4d_penghasilan_bruto_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Jumlah Penghasilan Bruto" min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Pajak Dipotong</label>
                                                        <input autocomplete="off"   id="b4d_jumlahpajak_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b4d_jumlahpajak_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Jumlah Pajak Dipotong" min="0">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 row">
                                                    <div class="col-sm-4">
                                                        <label>Penerima Penghasilan</label>
                                                        <input autocomplete="off"   id="b4e_penerima_penghasilan_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b4e_penerima_penghasilan_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Penerima Penghasilan" min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Penghasilan Bruto</label>
                                                        <input autocomplete="off"   id="b4e_penghasilan_bruto_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b4e_penghasilan_bruto_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Jumlah Penghasilan Bruto" min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Pajak Dipotong</label>
                                                        <input autocomplete="off"   id="b4e_jumlahpajak_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b4e_jumlahpajak_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Jumlah Pajak Dipotong" min="0">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 row">
                                                    <div class="col-sm-4">
                                                        <label>Penerima Penghasilan</label>
                                                        <input autocomplete="off"   id="b4f_penerima_penghasilan_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b4f_penerima_penghasilan_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Penerima Penghasilan" min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Penghasilan Bruto</label>
                                                        <input autocomplete="off"   id="b4f_penghasilan_bruto_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b4f_penghasilan_bruto_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Jumlah Penghasilan Bruto" min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Pajak Dipotong</label>
                                                        <input autocomplete="off"   id="b4f_jumlahpajak_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b4f_jumlahpajak_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Jumlah Pajak Dipotong" min="0">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 row">
                                                    <div class="col-sm-4">
                                                        <label>Penerima Penghasilan</label>
                                                        <input autocomplete="off"   id="b5_penerima_penghasilan_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b5_penerima_penghasilan_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Penerima Penghasilan" min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Penghasilan Bruto</label>
                                                        <input autocomplete="off"   id="b5_penghasilan_bruto_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b5_penghasilan_bruto_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Jumlah Penghasilan Bruto" min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Pajak Dipotong</label>
                                                        <input autocomplete="off"   id="b5_jumlahpajak_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b5_jumlahpajak_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Jumlah Pajak Dipotong" min="0">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 row">
                                                    <div class="col-sm-4">
                                                        <label>Penerima Penghasilan</label>
                                                        <input autocomplete="off"   id="b6_penerima_penghasilan_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b6_penerima_penghasilan_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Penerima Penghasilan" min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Penghasilan Bruto</label>
                                                        <input autocomplete="off"   id="b6_penghasilan_bruto_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b6_penghasilan_bruto_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Jumlah Penghasilan Bruto" min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Pajak Dipotong</label>
                                                        <input autocomplete="off"   id="b6_jumlahpajak_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b6_jumlahpajak_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Jumlah Pajak Dipotong" min="0">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 row">
                                                    <div class="col-sm-4">
                                                        <label>Penerima Penghasilan</label>
                                                        <input autocomplete="off"   id="b7_penerima_penghasilan_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b7_penerima_penghasilan_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Penerima Penghasilan" min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Penghasilan Bruto</label>
                                                        <input autocomplete="off"   id="b7_penghasilan_bruto_1721"
                                                            name="b7_penghasilan_bruto_1721" type="text" class="form-control"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            placeholder="Masukkan Jumlah Penghasilan Bruto" min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Pajak Dipotong</label>
                                                        <input autocomplete="off"   id="b7_jumlahpajak_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b7_jumlahpajak_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Jumlah Pajak Dipotong" min="0">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 row">
                                                    <div class="col-sm-4">
                                                        <label>Penerima Penghasilan</label>
                                                        <input autocomplete="off"   id="b8_penerima_penghasilan_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b8_penerima_penghasilan_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Penerima Penghasilan" min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Penghasilan Bruto</label>
                                                        <input autocomplete="off"   id="b8_penghasilan_bruto_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b8_penghasilan_bruto_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Jumlah Penghasilan Bruto" min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Pajak Dipotong</label>
                                                        <input autocomplete="off"   id="b8_jumlahpajak_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b8_jumlahpajak_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Jumlah Pajak Dipotong" min="0">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 row">
                                                    <div class="col-sm-4">
                                                        <label>Penerima Penghasilan</label>
                                                        <input autocomplete="off"   id="b9_penerima_penghasilan_1721"
                                                            name="b9_penerima_penghasilan_1721" type="text" class="form-control"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            placeholder="Masukkan Penerima Penghasilan" min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Penghasilan Bruto</label>
                                                        <input autocomplete="off"   id="b9_penghasilan_bruto_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b9_penghasilan_bruto_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Jumlah Penghasilan Bruto" min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Pajak Dipotong</label>
                                                        <input autocomplete="off"   id="b9_jumlahpajak_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b9_jumlahpajak_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Jumlah Pajak Dipotong" min="0">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 row">
                                                    <div class="col-sm-4">
                                                        <label>Penerima Penghasilan</label>
                                                        <input autocomplete="off"   id="b10_penerima_penghasilan_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b10_penerima_penghasilan_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Penerima Penghasilan" min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Penghasilan Bruto</label>
                                                        <input autocomplete="off"   id="b10_penghasilan_bruto_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b10_penghasilan_bruto_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Jumlah Penghasilan Bruto" min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Pajak Dipotong</label>
                                                        <input autocomplete="off"   id="b10_jumlahpajak_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="b10_jumlahpajak_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Jumlah Pajak Dipotong" min="0">
                                                    </div>
                                                </div>
                                                <h6>11. Jumlah</h6>
                                                <div class="mb-3 row">
                                                    <div class="col-sm-4">
                                                        <label>Penerima Penghasilan</label>
                                                        <input autocomplete="off" readonly   id="b11_penerima_penghasilan_1721"
                                                            name="b11_penerima_penghasilan_1721" type="text" class="form-control" min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Penghasilan Bruto</label>
                                                        <input autocomplete="off" readonly   id="b11_penghasilan_bruto_1721"
                                                            name="b11_penghasilan_bruto_1721" type="text" class="form-control" min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Pajak Dipotong</label>
                                                        <input autocomplete="off" readonly   id="b11_jumlahpajak_1721"
                                                            name="b11_jumlahpajak_1721" type="text" class="form-control" min="0">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input autocomplete="off"   id="pokokpajak_1721" onkeyup="this.value=sprator(this.value);"
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input autocomplete="off"   id="kelebihanpenyetor_1721"
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input autocomplete="off"   id="sptdibetulkan_1721" placeholder="Masukkan SPT Di Betulkan"
                                                ...
                                                <h6>1. Penerima Uang Pesangon Yang Dibayarkan Sekaligus | 21-401-01</h6>
                                                <div class="mb-3 row">
                                                    <div class="col-sm-4">
                                                        <label>Penerima Penghasilan</label>
                                                        <input autocomplete="off"   id="c1_penerima_penghasilan_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="c1_penerima_penghasilan_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Penerima Penghasilan" min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Penghasilan Bruto</label>
                                                        <input autocomplete="off"   id="c1_penghasilan_bruto_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="c1_penghasilan_bruto_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Jumlah Penghasilan Bruto" min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Pajak Dipotong</label>
                                                        <input autocomplete="off"   id="c1_jumlahpajak_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="c1_jumlahpajak_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Jumlah Pajak Dipotong" min="0">
                                                    </div>
                                                </div>
                                                <h6>2. Penerima Uang Manfaat Pensiun, Tunjangan Hari Tua Atau Jaminan Hari Tua Dan Pembayaran Sejenis Yang Dibayarkan Sekaligus | 21-401-02</h6>
                                                <div class="mb-3 row">
                                                    <div class="col-sm-4">
                                                        <label>Penerima Penghasilan</label>
                                                        <input autocomplete="off"   id="c2_penerima_penghasilan_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="c2_penerima_penghasilan_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Penerima Penghasilan" min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Penghasilan Bruto</label>
                                                        <input autocomplete="off"   id="c2_penghasilan_bruto_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="c2_penghasilan_bruto_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Jumlah Penghasilan Bruto" min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Pajak Dipotong</label>
                                                        <input autocomplete="off"   id="c2_jumlahpajak_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="c2_jumlahpajak_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Jumlah Pajak Dipotong" min="0">
                                                    </div>
                                                </div>
                                                <h6>3. Pejabat Negara, Pegawai Negeri Sipil, Anggota TNI/POLRI Dan Pensiunan Yang Menerima Honorarium Dan Imbalan Lain Yang Dibebankan Kepada Keuangan Negara/Daerah | 21-401-01</h6>
                                                <div class="mb-3 row">
                                                    <div class="col-sm-4">
                                                        <label>Penerima Penghasilan</label>
                                                        <input autocomplete="off"   id="c3_penerima_penghasilan_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="c3_penerima_penghasilan_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Penerima Penghasilan" min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Penghasilan Bruto</label>
                                                        <input autocomplete="off"   id="c3_penghasilan_bruto_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="c3_penghasilan_bruto_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Jumlah Penghasilan Bruto" min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Pajak Dipotong</label>
                                                        <input autocomplete="off"   id="c3_jumlahpajak_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="c3_jumlahpajak_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Jumlah Pajak Dipotong" min="0">
                                                    </div>
                                                </div>
                                                <h6>4. Penerima Penghasilan Yang Dipotong PPh Pasal 21 Final Lainnya | 21-499-99</h6>
                                                <div class="mb-3 row">
                                                    <div class="col-sm-4">
                                                        <label>Penerima Penghasilan</label>
                                                        <input autocomplete="off"   id="c4_penerima_penghasilan_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="c4_penerima_penghasilan_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Penerima Penghasilan" min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Penghasilan Bruto</label>
                                                        <input autocomplete="off"   id="c4_penghasilan_bruto_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="c4_penghasilan_bruto_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Jumlah Penghasilan Bruto" min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Pajak Dipotong</label>
                                                        <input autocomplete="off"   id="c4_jumlahpajak_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            name="c4_jumlahpajak_1721" type="text" class="form-control"
                                                            placeholder="Masukkan Jumlah Pajak Dipotong" min="0">
                                                    </div>
                                                </div>
                                                <h6>5. Jumlah</h6>
                                                <div class="mb-3 row">
                                                    <div class="col-sm-4">
                                                        <label>Penerima Penghasilan</label>
                                                        <input autocomplete="off" id="jumlah_penerima_penghasilan_1721"readonly
                                                            name="jumlah_penerima_penghasilan_1721" type="text" class="form-control"
                                                            min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Penghasilan Bruto</label>
                                                        <input autocomplete="off" id="jumlah_penghasilan_bruto_1721"readonly
                                                            name="jumlah_penghasilan_bruto_1721" type="text" class="form-control"
                                                            min="0">
                                                    </div>
                                                    <div class="col-sm-4">
                                                        <label>Jumlah Pajak Dipotong</label>
                                                        <input autocomplete="off" id="jumlah_jumlahpajak_1721"readonly
                                                            name="jumlah_jumlahpajak_1721" type="text" class="form-control"
                                                            min="0">
                                                    </div>
                                                </div>
                                                <hr>
                                                        ...
                                                        <table id="penerimapensiun_1721"class="display"
                                                            ...
                                                            <tbody>
                                                                <tr>
                                                                    ...
                                                                    <td width="auto" class="text-center">
                                                                        <input   autocomplete="off" type="text" min="0"
                                                                            onkeyup="this.value=sprator(this.value);"
                                        ...
                                        <div class="tab-pane fade" id="nav-1721V" role="tabpanel"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="mb-3 row">
                                                    <label class="col-sm-3 col-form-label">Masa Pajak</label>
                                                    <div class="col-sm-9">
                                                        <input   autocomplete="off" id="masapajak_formulirV_1721" name="masapajak_formulirV_1721"
                                                            type="date" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input   placeholder="Masukkan Gaji,Upah,Bonus,Gratifikasi,Honorarium,THR dll..." autocomplete="off"
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input   placeholder="Masukkan Biaya Transportasi..." autocomplete="off"
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input   placeholder="Masukkan Biaya Penyusutan Dan Amortasi..." autocomplete="off"
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input   placeholder="Masukkan Biaya Sewa..." autocomplete="off"
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input   placeholder="Masukkan Biaya Bunga Pinjaman..." autocomplete="off"
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input   placeholder="Masukkan Biaya Sehubungan Dengan Jasa..." autocomplete="off"
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input   placeholder="Masukkan Biaya Piutang Tak Tertagih..." autocomplete="off"
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input   placeholder="Masukkan Biaya Royalti..." autocomplete="off"
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input   placeholder="Masukkan Biaya Pemasaran / Promosi..." autocomplete="off"
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input   placeholder="Masukkan Biaya Lain..." autocomplete="off"
                                        ...
                                        <div class="tab-pane fade" id="nav-1721VI" role="tabpanel"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input min="0"   placeholder="Masukkan Nomor" autocomplete="off" id="nomor_formulirVI_1721" name="nomor_formulirVI_1721"
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input min="0"   placeholder="Masukkan NPWP" autocomplete="off"
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input min="0"   placeholder="Masukkan NIK / No.Paspor" autocomplete="off"
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input   placeholder="Masukkan Nama" autocomplete="off"
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <textarea   placeholder="Masukkan Alamat" autocomplete="off"
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input min="0"   placeholder="Masukkan Kode Negara Domisili" autocomplete="off"
                                                ...
                                                <div class="mb-3 row">
                                                    <label class="col-sm-3 col-form-label">1. NPWP</label>
                                                    <div class="col-sm-9">
                                                        <input min="0"   placeholder="Masukkan NPWP Identitas Pemotong" autocomplete="off"
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input   placeholder="Masukkan Nama Identitas Pemotong" autocomplete="off"
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input   placeholder="Masukkan Tanggal Dan Tanda Tangan" autocomplete="off"
                                        ...
                                        <div class="tab-pane fade" id="nav-1721VII" role="tabpanel"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="mb-3 row">
                                                    <label class="col-sm-3 col-form-label">Nomor</label>
                                                    <div class="col-sm-9">
                                                        <input min="0"   placeholder="Masukkan Nomor" autocomplete="off" id="nomor_formulirVII_1721" name="nomor_formulirVII_1721"
                                                            type="number" class="form-control">
                                                    </div>
                                                </div>
                                                <hr>
                                                ...
                                                <div class="mb-3 row">
                                                    <label class="col-sm-3 col-form-label">2. Nama</label>
                                                    <div class="col-sm-9">
                                                        <input   placeholder="Masukkan Nama Pemotong" autocomplete="off"
                                        ...
                                        <div class="tab-pane fade" id="nav-1721A1" role="tabpanel"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="mb-3 row">
                                                    <label class="col-sm-3 col-form-label">Nomor</label>
                                                    <div class="col-sm-9">
                                                        <input min="0"   placeholder="Masukkan Nomor" autocomplete="off" id="nomor_formulirA1_1721" name="nomor_formulirA1_1721"
                                                            type="number" class="form-control">
                                                    </div>
                                                </div>
                                                <hr>
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input   placeholder="Masukkan Masa Perolehan" 
                                                ...
                                                <div class="mb-3 row">
                                                    <label class="col-sm-3 col-form-label">NPWP Pemotong</label>
                                                    <div class="col-sm-9">
                                                        <input min="0"   placeholder="Masukkan NPWP Pemotong" 
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input min="0"   placeholder="Masukkan Nama Pemotong" 
                                                ...
                                                <div class="mb-3 row">
                                                    <label class="col-sm-3 col-form-label">1. NPWP</label>
                                                    <div class="col-sm-9">
                                                        <input   placeholder="Masukkan NPWP Penerima" min="0"
                                                ...
                                                <div class="mb-3 row">
                                                    <label class="col-sm-3 col-form-label">2. NIK</label>
                                                    <div class="col-sm-9">
                                                        <input   placeholder="Masukkan NIK / No Paspor" min="0"
                                                ...
                                                <div class="mb-3 row">
                                                    <label class="col-sm-3 col-form-label">4. Alamat</label>
                                                    <div class="col-sm-9">
                                                        <textarea   placeholder="Masukkan Alamat Penerima" 
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input min="0"   placeholder="Masukkan Kode Negara" 
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input min="0"   placeholder="Masukkan Gaji,Pensiun dan THT" 
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input min="0"   placeholder="Masukkan Tunjangan PPh" 
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input min="0"   placeholder="Masukkan Tunjangan Lain" 
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input min="0"   placeholder="Masukkan Honorarium" 
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input min="0"   placeholder="Masukkan Preim Asuransi" 
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input min="0"   placeholder="Masukkan Tantiem,Bonus,Gratifikasi,Jasa Produksi dan THR" 
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input min="0"   placeholder="Masukkan Biaya Jabatan / Biaya Pensiun"
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input min="0"   placeholder="Masukkan Iuran Pensiun, Iuran JHT/THT"
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input min="0"   placeholder="Masukkan Penghasilan Neto Masa" autocomplete="off" id="penghasilanNetoMasa_formulirA1_1721" name="penghasilanNetoMasa_formulirA1_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            type="text" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input min="0"   placeholder="Masukkan Jumlah Penghasilan Neto" autocomplete="off" id="jumlahPenghasilanNetoSetaun_formulirA1_1721" name="jumlahPenghasilanNetoSetaun_formulirA1_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            type="text" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input min="0"   placeholder="Masukkan PTKP" autocomplete="off" id="ptkp_formulirA1_1721" name="ptkp_formulirA1_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            type="text" class="form-control">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input min="0" onkeyup="this.value=sprator(this.value);"
                                                          placeholder="Masukkan PKP" autocomplete="off" id="ataspkp_formulirA1_1721" name="ataspkp_formulirA1_1721"
                                                            type="text" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input min="0" onkeyup="this.value=sprator(this.value);"
                                                          placeholder="Masukkan Masa Yang Dipotong" autocomplete="off" id="masayngDipotong_formulirA1_1721" name="masayngDipotong_formulirA1_1721"
                                                            type="text" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input min="0" onkeyup="this.value=sprator(this.value);"
                                                          placeholder="Masukkan Terutang" autocomplete="off" id="terutang_formulirA1_1721" name="terutang_formulirA1_1721"
                                                            type="text" class="form-control">
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input min="0" onkeyup="this.value=sprator(this.value);"
                                                          placeholder="Masukkan Terlunasi" autocomplete="off" id="terlunasi_formulirA1_1721" name="terlunasi_formulirA1_1721"
                                                            type="text" class="form-control">
                                                    </div>
                                                </div>
                                                <hr>
                                                ...
                                                <div class="mb-3 row">
                                                    <label class="col-sm-3 col-form-label">1. NPWP</label>
                                                    <div class="col-sm-9">
                                                        <input   placeholder="Masukkan NPWP Pemotong" autocomplete="off" id="npwpIdPem_formulirA1_1721" name="npwpIdPem_formulirA1_1721"
                                                ...
                                                <div class="mb-3 row">
                                                    <label class="col-sm-3 col-form-label">2. Nama</label>
                                                    <div class="col-sm-9">
                                                        <input   placeholder="Masukkan Nama Pemotong" autocomplete="off" id="namaIdPem_formulirA1_1721" name="namaIdPem_formulirA1_1721"
                                                            type="text" class="form-control" min="0">
                                                    </div>
                                                </div>
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input   autocomplete="off" id="tglIdPem_formulirA1_1721" name="tglIdPem_formulirA1_1721"
                                        ...
                                        <div class="tab-pane fade" id="nav-1721A2" role="tabpanel"
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="mb-3 row">
                                                    <label class="col-sm-3 col-form-label">Nomor</label>
                                                    <div class="col-sm-9">
                                                        <input min="0"   placeholder="Masukkan Nomor" autocomplete="off" id="nomor_formulirA2_1721" name="nomor_formulirA2_1721"
                                                            type="number" class="form-control">
                                                    </div>
                                                </div>
                                                <hr>
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input   placeholder="Masukkan Nama Instansi" 
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input   placeholder="Masukkan Nama Bendahara" 
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input min="0"   placeholder="Masukkan NPWP Bendahara" 
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input   placeholder="Masukkan NPWP Penerima" 
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input   placeholder="Masukkan NIP/NRP" min="0"
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input   placeholder="Masukkan Pangkat / Golongan" 
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input min="0"   placeholder="Masukkan NIK Penerima" 
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-4">
                                                        <input   placeholder="Masukkan Jumlah" min="0" 
                                                            onkeyup="this.value=sprator(this.value);"
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input   placeholder="Masukkan Gaji Pokok" min="0" 
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input   placeholder="Masukkan Tunjangan Isteri" min="0" 
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input   placeholder="Masukkan Tunjangan Perbaikan" min="0" 
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input   placeholder="Masukkan Tunjangan Struktural" min="0" 
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input   placeholder="Masukkan Tunjangan Beras" min="0" 
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input   placeholder="Masukkan Tunjangan Khusus" min="0" 
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input   placeholder="Masukkan Tunjangan Lain-lain" min="0" 
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input   placeholder="Masukkan Biaya Jabatan/Biaya Pensiun" min="0" 
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input   placeholder="Masukkan Iuran Pensiun/Iuran THT" min="0" 
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input   min="0" placeholder="Masukkan Jumlah Penghasilan Neto Masa"
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input   min="0" placeholder="Masukkan Jumlah Penghasilan Penghitungan"
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input   min="0" placeholder="Masukkan Jumlah PTKP"
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input   min="0" placeholder="Masukkan PKP Setahun"
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input   min="0" placeholder="Masukkan Potongan Masa Sebelumnya"
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input   min="0" placeholder="Masukkan Terutang"
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-3">
                                                        <input   min="0" placeholder="Masukkan Gaji"
                                                            autocomplete="off" id="gaji_formulirA2_1721" name="gaji_formulirA2_1721"
                                                            onkeyup="this.value=sprator(this.value);"
                                                            type="text" class="form-control">
                                                    </div>
                                                    <div class="col-sm-3">
                                                        <input   min="0" placeholder="Masukkan Penghasilan"
                                                ...
                                                <div class="mb-3 row">
                                                    ...
                                                    <div class="col-sm-9">
                                                        <input   placeholder="Masukkan NIP/NRP" 
