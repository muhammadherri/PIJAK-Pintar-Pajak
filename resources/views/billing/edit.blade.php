                                ...
                                <form action="{{ route('billing/update',[$billing->id]) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input value="{{$billing->kode_akun_pajak}}" autocomplete="off" required id="kode_akun_pajak"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input value="{{$billing->npwp}}"  autocomplete="off" required id="npwp" name="npwp"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-4">
                                                <input value="{{$billing->end_periode_pajak}}" autocomplete="off" required id="end_periode_pajak"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input value="{{$billing->jumlah}}" autocomplete="off" required id="jumlah" name="jumlah"
