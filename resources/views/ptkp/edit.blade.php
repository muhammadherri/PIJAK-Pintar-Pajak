                                ...
                                <form action="{{ route('ptkp/update',[$ptkp->id]) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input value="{{$ptkp->status}}" required id="status" name="status"type="number" class="form-control"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input value="{{$ptkp->tanggungan}}" autocomplete="off" required id="tanggungan" name="tanggungan"type="number" class="form-control"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input value="{{$ptkp->besaran_ptkp}}" autocomplete="off" required id="besaran_ptkp" name="besaran_ptkp" type="number" class="form-control"
