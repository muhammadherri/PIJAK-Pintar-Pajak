                                ...
                                <form action="{{ route('kodeobjekpajak/update',[$kodepajak->id]) }}" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input autocomplete="off" value="{{$kodepajak->kode_objek_pajak}}" required id="kodeobjekpajak" name="kodeobjekpajak" type="text" class="form-control"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input autocomplete="off" value="{{$kodepajak->keterangan}}" required id="keterangan" name="keterangan" type="text" class="form-control"
                                        ...
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input autocomplete="off" value="{{$kodepajak->tarif}}" required id="tarif" name="tarif" type="number" class="form-control"
