        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form id="formship" action="{{ route('transaksi/update', $trx->id) }}" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group row">
                                    <div class="col-md-4">
                                        ...
                                        <div class="mb-2">
                                            ...
                                            <input type="text"value="{{$trx->kategori}}" id="kategori" name="kategori" class="form-control"
                                                required autocomplete="off">

                                        </div>
                                        <div class="mb-2">
                                            <label class="form-label" for="segment1">Nominal</label>
                                            <input value="{{$trx->nominal}}" type="text" id="nominal" name="nominal" class="form-control"
                                                required autocomplete="off">

                                        </div>
                                        <div class="mb-2">
                                            <label class="form-label" for="segment1">Deskripsi</label>
                                            <input value="{{$trx->deskripsi}}" type="text" id="deskripsi" name="deskripsi" class="form-control"
                                                required autocomplete="off">
