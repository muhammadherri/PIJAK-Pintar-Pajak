                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="basic-form">
                                <form action="{{ route('pphbadantahunan/store') }}" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input required autocomplete="off" id="dasar_pengenaan_pajak" name="dasar_pengenaan_pajak"onkeyup="this.value=separator(this.value);" 
                                    ...
                                    <div id=hidden_dptfas style="display:none;">
                                        <div class="row">
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input onkeyup="this.value=separator(this.value);" autocomplete="off" id="mendapat_fasilitas" name="mendapat_fasilitas"
                                    ...
                                    <div id=hidden_tdptfas style="display:none;">
                                        <div class="row">
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input onkeyup="this.value=separator(this.value);" autocomplete="off" id="tidak_mendapat_fasilitas" name="tidak_mendapat_fasilitas"
                                    ...
                                    <div id=hidden_hasildpp style="display:none;">
                                        <div class="row">
                                            <div class="mb-3 row">
                                                ...
                                                <div class="col-sm-9">
                                                    <input readonly autocomplete="off" id="hasildpp" name="hasildpp"
                                    ...
                                    <div class="row">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input required onkeyup="this.value=separator(this.value);"  autocomplete="off" id="jumlahpph" name="jumlahpph"
