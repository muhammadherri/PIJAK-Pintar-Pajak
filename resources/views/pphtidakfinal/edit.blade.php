                                ...
                                <form action="{{ route('pphtidakfinal/update',[$pphtidakfinal->id]) }}" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input required autocomplete="off"required onkeyup="this.value=addcommas(this.value);" value="{{$pphtidakfinal->bruto}}" id="bruto" name="bruto"
                                    ...
                                    <div class="row">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input required required onkeyup="this.value=addcommas(this.value);" autocomplete="off" value="{{$pphtidakfinal->dasar_pengenaan_pajak}}" id="pengenaan_pajak" name="pengenaan_pajak"
                                    ...
                                    <div class="row">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input required onkeyup="this.value=addcommas(this.value);" required autocomplete="off" value="{{$pphtidakfinal->tarif}}" id="tarif" name="tarif"
                                    ...
                                    <div class="row">
                                        <div class="mb-3 row">
                                            ...
                                            <div class="col-sm-9">
                                                <input required onkeyup="this.value=addcommas(this.value);" required autocomplete="off" value="{{$pphtidakfinal->potongan_pph}}" id="potongan_pph" name="potongan_pph"
