        ...
        <div class="container-fluid">
            <div class="row page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="javascript:void(0)">PPH 21 Tidak Final</a></li>
                </ol>
            </div>
            <!-- row -->
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        <div class="card-header">
                            ...
                            <div class="row">
                                <div class="col-lg-6">
                                    <a class="btn btn-primary" href="{{ route('pphtidakfinal/create') }}">
                                        {{ __('Tambah') }}
                                    </a>
                                </div>
                            </div>
                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table id="pphtidakfinal" class="display" style="min-width: 845px">
                                    <thead>
                                        <tr>
                                            <th></th>
                                                    <th>No Transaksi</th>
