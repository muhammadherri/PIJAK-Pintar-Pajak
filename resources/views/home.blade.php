                                        ...
                                        <div class="row  mt-xl-0 mt-4">
                                            <div class="col-md-6">
                                                ...
                                                <ul class="card-list mt-4">
                                                    ...
                                                    <li><span class="bg-warning circle"></span>Restaurant<span>15%</span>
                                                    </li>
                    ...
                    <div class="col-xl-3 col-xxl-5">
                        <div class="card">
                            <div class="card-header pb-0 border-0">
                                ...
                                <ul class="card-list">
                                    <li class="justify-content-end">Income<span class="bg-success circle me-0 ms-2"></span>
                                    </li>
                                    <li class="justify-content-end">Outcome<span class="bg-danger circle me-0 ms-2"></span>
                                    </li>
                                </ul>
                            </div>
