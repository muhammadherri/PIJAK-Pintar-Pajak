...
class Spt1770SController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $data = array(
            ...
            'a1_penghasil'=>$request->a1_rupiah_1770s,
            'a2_penghasil'=>$request->a2_rupiah_1770s,
            'a3_penghasil'=>$request->a3_rupiah_1770s,
            'a4_penghasil'=>$request->a4_rupiah_1770s,
            'a5_penghasil'=>$request->a5_rupiah_1770s,
            'a6_penghasil'=>$request->a6_rupiah_1770s,
            'b7_kena_pajak'=>$request->b7_penghasilankenapajak,
            'b7_penghasil'=>$request->b7_rupiah_1770s,
            'b8_penghasil'=>$request->b8_rupiah_1770s,
            'c9_terutang'=>$request->c9_rupiah_1770s,
            'c10_terutang'=>$request->c10_rupiah_1770s,
            'c11_terutang'=>$request->c11_rupiah_1770s,
            'd12_kredit'=>$request->d12_rupiah_1770s,
            'pph_dibayar'=>$request->d13_pph_1770s,
            'd13_kredit'=>$request->d13_jumlah_1770s,
            'd14a_kredit'=>$request->d14a_rupiah_1770s,
            'd14b_kredit'=>$request->d14b_rupiah_1770s,
            'd15_kredit'=>$request->d15_rupiah_1770s,
            'e_kurangbayar'=>$request->e16_pph_1770s,
            'e16_date_kurangbayar'=>Carbon::parse($request->e16_date_1770s)->format('d-M-Y'),
            'e16_jumlah_kurangbayar'=>$request->e16_rupiah_1770s,
            'e17_kurangbayar'=>$request->e17_permohonan_1770s,
            'f18_lebihbayar_kurangbayar'=>$request->f18_permohonan_1770s,
            'f18_rupiah_kurangbayar'=>$request->f18_rupiah_1770s,
