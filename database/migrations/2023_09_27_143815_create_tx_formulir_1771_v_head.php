...
return new class extends Migration
{
    ...
    public function up()
    {
        Schema::create('tx_formulir_1771_v_head', function (Blueprint $table) {
            $table->increments('id');
            ...
            $table->float('jumlah_modal_setor');
            $table->float('jumlah_deviden');
    ...
    {
        Schema::dropIfExists('tx_formulir_1771_v_head');
    }
};
